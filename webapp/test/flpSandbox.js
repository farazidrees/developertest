		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#aucombournedigitaldevelopertest-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aucombournedigitaldevelopertest-display": {
								"semanticObject": "aucombournedigitaldevelopertest",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=au.com.bournedigital.developertest",
									"url": sap.ui.require.toUrl("au/com/bournedigital/developertest")
								}
							}
						}
					}
